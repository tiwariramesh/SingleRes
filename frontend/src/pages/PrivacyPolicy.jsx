...
const PrivacyPolicy = () => {
    return (
        <div className="min-h-screen bg-white font-sans text-pmi-navy selection:bg-pmi-blue selection:text-white flex flex-col">
            <Navbar initials="PP" firstName="Privacy" lastName="Policy" />

            <main className="flex-grow pt-32 pb-24">
                <div className="container mx-auto px-4 max-w-4xl">
                    <h1 className="text-4xl font-black text-pmi-navy mb-8">Privacy Policy</h1>
                    <p className="text-slate-500 mb-12">Last Updated: {new Date().toLocaleDateString('en-AU')}</p>

                    <div className="space-y-12 text-slate-700 leading-relaxed">
                        <section>
                            <h2 className="text-2xl font-bold text-pmi-navy mb-4">1. Introduction</h2>
                            <p>
                                We are committed to protecting your personal information and respecting your privacy. This Privacy Policy explains how we collect, use, and disclose personal information in accordance with the <strong className="text-pmi-blue">Privacy Act 1988 (Cth)</strong> and the <strong className="text-pmi-blue">Australian Privacy Principles (APPs)</strong>.
                            </p>
                        </section>

                        <section>
                            <h2 className="text-2xl font-bold text-pmi-navy mb-4">2. Collection of Personal Information</h2>
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-pmi-navy mb-4">3. Use of Personal Information</h2>
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-pmi-navy mb-4">4. Disclosure of Personal Information</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-pmi-navy mb-4">5. Data Security</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-pmi-navy mb-4">6. Access and Correction</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-pmi-navy mb-4">7. Contact Us</h2>
                            <p>
                                If you have any questions about this Privacy Policy or our privacy practices, please contact us at:
                            </p>
                            <div className="mt-4 p-6 bg-slate-50 rounded-xl border border-slate-100">
                                <p className="font-bold text-pmi-navy">Privacy Officer</p>
                                <p>Email: <a href="mailto:privacy@agileprofessional.com.au" className="text-pmi-blue hover:underline">privacy@agileprofessional.com.au</a></p>
                            </div>
                        </section>
                    </div>
                </div>
