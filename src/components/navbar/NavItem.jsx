...
export const NavItem = ({ label, href, onClick }) => {
    return (
        <a
            ...
            className="text-[12px] font-bold text-pmi-navy dark:text-white hover:text-pmi-blue dark:hover:text-blue-400 transition-all duration-200 tracking-normal relative group"
        >
            {label}
