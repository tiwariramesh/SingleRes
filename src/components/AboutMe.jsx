...
const tabData = [
    {
        ...
        label: "My Journey",
        content: (
            <div className="space-y-6 text-[12px] text-slate-700 dark:text-slate-300 font-light leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-700">
                <p>
...
const AboutMe = () => {
    const activeImage = tabData[0].image;
    const content = tabData[0].content;

    return (
        <section id="about" className="pt-0 pb-16 bg-gradient-to-b from-white via-slate-50 to-white dark:from-slate-950 dark:via-slate-900/50 dark:to-slate-950 overflow-hidden transition-colors duration-300">
                ...
                <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                    ...
                    <div className="lg:col-span-5 relative flex justify-center items-center">
                        ...
                        <img
                            src={activeImage}
                            alt="About Me"
                            className="rounded-3xl shadow-xl object-cover h-48 md:h-64 w-full border-2 border-white/80 dark:border-slate-800/80 transition-all duration-500"
                        />
                    </div>
