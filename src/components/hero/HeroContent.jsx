...
export const HeroContent = ({ title, subtitle, bio }) => {
    ...
    return (
        <div className="lg:col-span-12 xl:col-span-7 space-y-4 lg:space-y-6 text-center lg:text-left">
            ...
            <div className="text-[20px] text-muted-foreground dark:text-slate-400 font-medium leading-relaxed max-w-2xl mx-auto lg:mx-0" dangerouslySetInnerHTML={{ __html: bio }} />
            ...
            <div className="pt-4 flex justify-center lg:justify-start">
                <div className="w-[70vw] lg:w-[70%] h-px bg-slate-200 dark:bg-slate-800"></div>
            </div>
        </div>
    );
};
