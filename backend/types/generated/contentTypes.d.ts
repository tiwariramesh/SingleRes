...
export interface ApiExperienceExperience extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Career timeline showing work history';
...
export interface ApiExpertiseTagExpertiseTag
  extends Struct.CollectionTypeSchema {
  collectionName: 'expertise_tags';
  info: {
    description: 'Highlight tags for the hero section';
    displayName: 'Expertise Tag';
    pluralName: 'expertise-tags';
    singularName: 'expertise-tag';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    icon: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'check-circle-2'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::expertise-tag.expertise-tag'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    order: Schema.Attribute.Integer;
...
export interface ApiIndustryIndustry extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Industry and domain experience tags';
...
export interface ApiProfileProfile extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Main profile information for the resume website';
    displayName: 'Profile';
    pluralName: 'profiles';
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['Web App', 'Mobile App', 'API', 'E-commerce', 'Other']
    >;
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Services offered by the professional';
    displayName: 'Service';
    pluralName: 'services';
...
export interface ApiSkillSkill extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Skills and competencies organized by categories';
    displayName: 'Skill';
    pluralName: 'skills';
    singularName: 'skill';
  };
...
export interface ApiSocialLinkSocialLink extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    showInContact: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
...
export interface ApiSocialProofSocialProof extends Struct.CollectionTypeSchema {
  collectionName: 'social_proofs';
  info: {
    description: 'Statistics and trust indicators';
    displayName: 'Social Proof';
    pluralName: 'social-proofs';
    singularName: 'social-proof';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::expertise-tag.expertise-tag': ApiExpertiseTagExpertiseTag;
      ...
      'api::social-proof.social-proof': ApiSocialProofSocialProof;
